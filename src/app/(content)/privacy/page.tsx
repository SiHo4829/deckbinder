...
export const metadata: Metadata = {
  title: "개인정보처리방침",
  description: "덱바인더가 수집하는 정보와 이용 방법, 쿠키 관련 사항을 안내합니다.",
...
export default function PrivacyPage() {
  return (
    <div>
        ...
        <table className="mt-3 w-full text-xs">
          ...
          <tbody>
            <tr className="border-b">
              ...
              <td className="py-2 pr-3">카드 이미지 요청의 과다 호출 차단</td>
              <td className="py-2">요청 시점의 카운터로만 유지(최대 1시간) · 별도 저장 없음</td>
            </tr>
            <tr className="border-b">
      ...
      <Section title="3. 정보주체의 권리와 행사 방법">
        <p>
