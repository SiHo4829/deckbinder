 ...
 *
 * 🚨 `workers/`에는 이 프로젝트 하나뿐이다. ~~`workers/crawler`(A) 매물
 * 크롤러~~는 만들어지기 전에 폐기됐다(2026-09-03 · plan §5.7 — 실물 0건).
 * ⚠️ 그래도 이 문단을 지우지 않는다: 설계 원문이 plan-archive에 남아 있어
 * 누가 다시 읽는 날 "한쪽 규칙을 다른 쪽에 적용"이 실제로 일어난다.
 */
